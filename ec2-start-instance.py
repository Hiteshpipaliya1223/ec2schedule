#START THE EC2INSTANCE USING LAMBDA
...
def lambda_handler(event, context):
    ...
    ec2_client = boto3.client('ec2', region_name='eu-west-2') # Replace your Region name

    # Specify the instance ID of the EC2 instance you want to start
    instance_id = 'i-0db0f0b888344a43a' # Replace your Own Instance ID
